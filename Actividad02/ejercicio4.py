...
çpaís +34, y la extensión tiene dos dígitos (por ejemplo +34-955724710-56). Escribir un programa que pregunte por un
número de teléfono con este formato y muestre por pantalla el número de teléfono sin el prefijo y la extensión.
'''
preg = input("Introduce un número de teléfono con formato +34-XXXXXXXXX-XX\n")
if len(preg) != 16:
